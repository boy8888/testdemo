 ...
 * 本类主要做为 线下支付事件
 */
public class OfflinePayUndoEvent implements DataSyncEvent{

	OfflineUndoDataSync dataSyncbody;
	 ...
	 * @param ext 
	 */
	public OfflinePayUndoEvent(TransOrderVO2<AntiPayoffline> transorder,
			ZJProduct zjProduct, ResultModel rm, String mobilenum, Map ext) {
		dataSyncbody = new OfflineUndoDataSync(transorder,rm,zjProduct,mobilenum,ext);
	}
