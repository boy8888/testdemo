 ...
 * 本类主要做为
 */
public class OfflinePayOrderVO extends BasePosVO implements IOrderVO {
	...
	public String getPaintText() {
		...
		return ValidateUtil.sortbyValues(mobileNum,paymentCodeDES,sum.toString(),sellerId,storeId,terminalId,operatorId,remark,appOrderId,terminalOrderId,productName);
	}
	...
	public void selfvalidate() throws DataInvalidException {
		ValidateUtil.assertNull(this.paymentCodeDES, "身份证号");
	...
	public String toString() {
		return "OfflinePayOrderVO [mobileNum=" + mobileNum
