...
/**
 * @author dp qiu
 * 2015年3月24日 下午2:55:45
 * 本类主要做为controller输出
 */
public class DisCardResultVO {
	...
	public DisCardResultVO(DiscountCardAccount account,DiscountCardProduct product){
	 ...
	 * 构造函数
	 */
	public DisCardResultVO(DiscountCardAccount account) {
