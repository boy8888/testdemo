 ...
 * 本类主要做为重置密码对象
 */
public class ResetPasswordWithSmscodeVO extends AppBaseVO implements AppMobileDecidable {

	/**
	 * 注册信息
	 */
	private  ResetPasswordWithSmscodeDetailVO login;
	
	/**
	 *注册信息
	 */
	public ResetPasswordWithSmscodeDetailVO getLogin() {
		return login;
	}
	/**
	 * 注册信息
	 */
	public void setLogin(ResetPasswordWithSmscodeDetailVO loginInfo) {
